...
sum_juv_sf_new_extrap = st_read(paste0(out_path,'gpkg/Rch_Cap_RF_New_juv_summer.gpkg')) %>%
  st_transform(WS_crs)
win_juv_sf_new_extrap = st_read(paste0(out_path,'gpkg/Rch_Cap_RF_New_juv_winter.gpkg')) %>%
  st_transform(WS_crs)
redds_sf_new_extrap = st_read(paste0(out_path,'gpkg/Rch_Cap_RF_New_redds.gpkg')) %>%
  st_transform(WS_crs)
