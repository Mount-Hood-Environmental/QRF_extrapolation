...
```{r qrf-relimp-summer, fig.cap = "Relative importance plots for covariates included in the juvenile summer QRF models"}
...
```{r qrf-relimp-winter, fig.cap = "Relative importance plots for covariates included in the juvenile winter QRF models"}
...
```{r qrf-relimp-redds, fig.cap = "Relative importance plots for covariates included in the QRF redds models"}
...
```{r qrf-pdp-summer, fig.cap = "Partial dependence plots for covariates included in the juvenile summer QRF models"}
...
```{r qrf-pdp-winter, fig.cap = "Partial dependence plots for covariates included in the juvenile winter QRF models"}
...
```{r qrf-pdp-redds, fig.cap = "Partial dependence plots for covariates included in the QRF redds models"}
