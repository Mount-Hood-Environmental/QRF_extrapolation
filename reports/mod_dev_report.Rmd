...
US_sum_sf_comp_extrap = bind_cols(setorder(US_sum_sf_old_extrap[,-c(21:32)], UniqueID), setorder(US_sum_sf_old_extrap, UniqueID)[,c(21:32)] - setorder(US_sum_sf_new_extrap, UniqueID)[,c(21:32)])

US_win_sf_comp_extrap = bind_cols(setorder(US_win_sf_old_extrap[,-c(21:32)], UniqueID), setorder(US_win_sf_old_extrap, UniqueID)[,c(21:32)] - setorder(US_win_sf_new_extrap, UniqueID)[,c(21:32)])

US_redds_sf_comp_extrap = bind_cols(setorder(US_redds_sf_old_extrap[,-c(21:32)], UniqueID), setorder(US_redds_sf_old_extrap, UniqueID)[,c(21:32)] - setorder(US_redds_sf_new_extrap, UniqueID)[,c(21:32)])
...
# Chinook salmon, summer parr
chnk_sum_cap_old = calc_watershed_cap(US_huc_sf,
                                  US_sum_sf_old_extrap,
                                  capacity_name = "chnk_per_m",
                                  capacity_se_name = "chnk_per_m_se",
                                  by_stream = T)

# Chinook salmon, winter presmolt
chnk_win_cap_old = calc_watershed_cap(US_huc_sf,
...
# Chinook salmon, redds
chnk_redd_cap_old = calc_watershed_cap(US_huc_sf,
...
# Old extrap for comparison ####
# steelhead, summer parr
sthd_sum_cap_old = calc_watershed_cap(US_huc_sf,
                                  US_sum_sf_old_extrap,
                                  capacity_name = "sthd_per_m",
                                  capacity_se_name = "sthd_per_m_se",
                                  by_stream = T)
...
# steelhead, winter presmolt
sthd_win_cap_old = calc_watershed_cap(US_huc_sf,
                                  US_win_sf_old_extrap,
                                  capacity_name = "sthd_per_m",
                                  capacity_se_name = "sthd_per_m_se",
                                  by_stream = T)
...
# steelhead, redds
sthd_redd_cap_old = calc_watershed_cap(US_huc_sf,
                                   US_redds_sf_old_extrap,
                                   capacity_name = "sthd_per_m",
                                   capacity_se_name = "sthd_per_m_se",
                                   by_stream = T)
...
chnk_sum_cap_comp = chnk_sum_cap_old %>%
  left_join(chnk_sum_cap_new, by = "StreamName")

$StreamName, StreamName),
  setorder(chnk_sum_cap_old[,c(4:5)], StreamName),
  )

bind_cols(setorder(US_sum_sf_old_extrap[,-c(21:32)], UniqueID), setorder(US_sum_sf_old_extrap, UniqueID)[,c(21:32)] - setorder(US_sum_sf_new_extrap, UniqueID)[,c(21:32)])
  
  bind_cols(apply(filter(chnk_sum_cap_new, StreamName != "Total"|is.na(StreamName))[,c(4,5)],2,sum),
                             apply(filter(chnk_sum_cap_comp, StreamName != "Total"|is.na(StreamName))[,c(4,5)],2,sum),
                             apply(filter(chnk_win_cap_new, StreamName != "Total"|is.na(StreamName))[,c(4,5)],2,sum),
                             apply(filter(chnk_win_cap_comp, StreamName != "Total"|is.na(StreamName))[,c(4,5)],2,sum),
                             apply(filter(chnk_redd_cap_new, StreamName != "Total"|is.na(StreamName))[,c(4,5)],2,sum),
                             apply(filter(chnk_redd_cap_comp, StreamName != "Total"|is.na(StreamName))[,c(4,5)],2,sum)) %>%
...
#### Comparison to previous extrapolation, by stream
