...
load(here('output/figures/juv_summer_Dash_figs.rda'))
rel_imp_p
...
load(here('output/figures/juv_winter_Dash_figs.rda'))
rel_imp_p
...
load(here('output/figures/redds_Dash_figs.rda'))
rel_imp_p
...
load(here('output/figures/RF_extrap_juv_summer_Dash.rda'))
ggarrange(chk_ri,
          stl_ri,
          common.legend = TRUE)
...
load(here('output/figures/RF_extrap_juv_winter_Dash.rda'))
ggarrange(chk_ri,
          stl_ri,
          common.legend = TRUE)
```
...
load(here('output/figures/RF_extrap_redds_Dash.rda'))
ggarrange(chk_ri,
          stl_ri,
          common.legend = TRUE)
```
