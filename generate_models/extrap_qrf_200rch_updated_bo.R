...
# quick comparison of capacity predictions with both models
...
p_champ_nochamp <- ggplot(aes(x = resp_champ,
             y = resp_no_champ), data = comp_pred_p) +
  geom_point() +
...
pdf(paste0("output/figures/", mod_choice,'_', cov_choice,"_pred_champ_nochamp.pdf"), width = 10, height = 8)
p_champ_nochamp
dev.off()
